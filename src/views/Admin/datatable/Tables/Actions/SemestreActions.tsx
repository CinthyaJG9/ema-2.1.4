...
const SemestreActions: FC<Props> = ({ id, tipo, valida, rowId, setRowId }) => {
  ...
  const handleSubmit = async (): Promise<void> => {
    setLoading(true);
    const result = await SemestreService.delete({
      id_sem: id,
      tipo_sem: tipo,
      valida_sem: valida ? 1 : 0,
    });
...
export default SemestreActions;
