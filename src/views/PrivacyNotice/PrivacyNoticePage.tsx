      ...
      <Box className=' relative -mt-[5.75rem] overflow-hidden pt-[5.75rem]'>
        ...
        <Box className='relative px-4 sm:px-6 lg:px-8'>
          ...
          <Box className=' flex w-full justify-center py-8'>
            <a
              className='flex w-2/12 cursor-pointer justify-center rounded-lg bg-secondary py-2 px-4 text-lg font-bold text-white transition-colors hover:bg-secondary-light'
              onClick={() => router.back()}
            >
                Regresar
                </a>
