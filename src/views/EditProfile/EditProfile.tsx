...
import { ICGenero, IProfile } from '@/interfaces';
...
const EditProfile: FC<Props> = ({ dataGenero }) => {
  ...
  const submit = async (dataForm: IProfile) => {
    ...
    const idGenValue = id_gen || 1; // si id_gen es nulo, asigna 1
  ...
  useEffect(() => {
    ...
    const convertedIdGen = id_gen || 1;
    const semValue = id_sem != null ? id_sem : 1;
    ...
    setValue('id_gen', convertedIdGen );
    setValue('id_sem', semValue);
    setValue('id_es', id_es !== null ? id_es : 1);
    setValue('id_per', id_per);
    setValue('boleta_est', boleta_est !== null ? boleta_est : '');
  }, []);
  ...
  render={({ field: { onChange } }) => (
    <Select
      ...
      onChange={onChange}
      errors={errors.id_gen ? errors.id_gen : { type: "", message: "" }}
    />
  )}
/>
            ...
            <Controller
              ...
              render={({ field: { onChange } }) => (
                <Select
                  ...
                  onChange={onChange}
                  errors={errors.id_sem ? errors.id_sem : { type: "", message: "" }}
                />
              )}
            />
              ...
              <Controller
                ...
                render={({ field: { onChange } }) => (
                  <Select
                    ...
                    onChange={onChange}
                    errors={errors.id_es ? errors.id_es : { type: "", message: "" }}
                  />
                )}
              />
            </div>
